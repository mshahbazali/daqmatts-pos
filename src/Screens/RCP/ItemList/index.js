                ...
                <ScrollView>
                    <View>
                        <View style={{ flexDirection: 'row', marginVertical: 13, marginHorizontal: 18, justifyContent: 'space-between', alignItems: 'center', }}>
                            <View style={{ width: "10%" }}>
                                <TouchableOpacity onPress={() => navigation.navigate("SalesInvoice")} style={{ backgroundColor: "yellow", padding: 10, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
                            ...
                            <View style={{ flexDirection: 'row', width: "50%", justifyContent: 'center', alignItems: 'center', }}>
                                <TextInput placeholder='Search' style={{ width: '80%', borderBottomColor: 'grey', borderBottomWidth: 1.3, fontSize: 19, fontWeight: '500', textAlign: 'center' }} />
                                <TouchableOpacity style={{ backgroundColor: "#D9D9D9", padding: 10, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', marginHorizontal: 12 }}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate("InvoiceLineList")} style={{ width: "10%", backgroundColor: "yellow", padding: 10, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
                                ...
                                <View style={styles.tableHeadContainer}>
                                    <View style={styles.tableBoxFirst}>
                                        <TouchableOpacity onPress={() => setModalVisible(!modalVisible)} style={styles.tableHead}>
                                            <Text style={styles.tableHeadText}>Item Code</Text>
                                        </TouchableOpacity>
                                    </View>
                                    ...
                                    <View style={styles.tableBoxSix}>
                                        <View style={styles.tableHead}>
                                            <Text style={styles.tableHeadText}>Good Qty</Text>
                                        </View>
                                    </View>
                                </View>
                                {/* Table Head End  */}
