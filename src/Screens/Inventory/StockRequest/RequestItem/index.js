        ...
        <ScrollView>
          <View>
            <View style={{ flexDirection: 'row', marginVertical: 13, marginHorizontal: 18, justifyContent: 'space-between', alignItems: 'center', }}>
              <View style={{ width: "10%" }}>
                <TouchableOpacity onPress={() => navigation.navigate("StockRequest")} style={{ backgroundColor: "yellow", padding: 10, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate("ItemListLine")} style={{ width: "10%", backgroundColor: "yellow", padding: 10, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
